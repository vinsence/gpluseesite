...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                               <!--  <li><a class="J_menuItem" href="form_avatar.html">修改头像</a></li> -->
                                <li><a class="J_menuItem" href="${ctx}/sys/user/modifyPwd" target="mainFrame">修改密码</a></li>
                                <li><a class="J_menuItem" target="mainFrame" href="${ctx}/sys/user/info">个人资料</a></li>
                                <li><a class="J_menuItem" href="contacts.html">联系我们</a></li>
                                <li><a class="J_menuItem" href="mailbox.html">信箱</a></li>
                                <li class="divider"></li>
                                <li><a href="${ctx}/logout" title="退出登录">安全退出</a></li>
                            </ul>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="index_v1.html" data-index="0">组织管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v2.html">角色管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v3.html">员工管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v4.html">字典管理</a>
                            </li>
                            <li>
                                <a href="index_v5.html" target="_blank">仓库维护</a>
                            </li>
                            <li>
                                <a href="index_v5.html" target="_blank">物料维护</a>
                            </li>
                        </ul>

                    </li>
                    <li>
                        <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">车队管理</span></a>
                    </li>
                     <li>
                        <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">客户管理</span></a>
                    </li> 
                    <li>
                        <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">客服管理</span></a>
                    </li> 
                    <li>
                        <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">运输管理</span></a>
                    </li> 
                    <li>
                        <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">仓储管理</span></a>
                    </li>
                     <li>
                        <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">财务管理</span></a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">报表分析</span></a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="${ctx}/logout" title="退出登录" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
    ...
    <script src="${ctxStatic}/js/contabs.min.js"></script>
