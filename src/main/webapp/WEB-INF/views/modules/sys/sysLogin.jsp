...
<footer class="white navbar-fixed-bottom">
    Copyright &copy; 2016-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="https://github.com/thinkgem/jeesite" target="_blank">GPLUS</a> ${fns:getConfig('version')}
</footer>
</body>
</html>